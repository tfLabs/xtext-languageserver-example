 ...
 * @since 2.11
 */
public class DryRunRequest<U, V> extends AbstractRequest<V> {
	private static final Logger LOG = Logger.getLogger(DryRunRequest.class);
	...
	public DryRunRequest(RequestManager requestManager, Function0<? extends U> nonCancellable,
